...
export default function DetailsPage() {
    return (
        <>
            ...
            <main className="p-6 pb-8 grid gap-4">
                <div>Voltar</div>
                ...
                <section className="p-3 border-y border-x rounded-lg">
                    <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. In rhoncus sagittis est et pulvinar. Mauris consequat rutrum turpis. Etiam commodo sem id tellus tempus porta. Praesent cursus purus neque, id dignissim lectus venenatis scelerisque. Suspendisse potenti. Phasellus volutpat placerat lacinia. In ultrices lobortis laoreet. Nunc a elementum mi. Proin sodales orci vitae vulputate iaculis. Nulla tincidunt lectus vitae nisi efficitur feugiat. Nunc sed turpis vitae lorem luctus porta ac sed odio. Sed at libero risus. Sed eget placerat orci, ut fringilla lectus. Proin eu vulputate dolor. Proin faucibus tempus felis.
                    </p>
                </section>
                <div className="p-3 border-y border-x rounded-lg flex items-center gap-2">
                    ...
                    Três Rios, Santa Catarina - Brasil
                </div>
                <div className="p-3 border-y border-x rounded-lg flex items-center gap-2">
                    <svg 
                        width="24px" 
                    ...
                    <Link 
                        href={"https://www.agraria.com.br"} 
                        target="_blank"
                        className="text-sky-400"
                    >https://www.agraria.com.br</Link>
                </div>
                <div className="p-3 border-y border-x rounded-lg flex items-center gap-2">
                    <svg 
                        width="24px" 
